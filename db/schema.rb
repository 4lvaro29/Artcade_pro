...
ActiveRecord::Schema.define(version: 20170926184554) do
  ...
  create_table "brands", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["component_id"], name: "index_brands_on_component_id", using: :btree
  end
  ...
  add_foreign_key "brands", "components"
